            ...
            <div className="flex items-center justify-center h-screen w-screen">
                ...
                className="bg-[#27273F] lg:w-2/5 lg:h-4/5 md:w-3/5 md:h-3/5 w-3/4 h-3/5">
                    ...
                    <div className="flex flex-col items-center justify-center mt-100 mb-100 lg:mt-100 lg:mb-100 md:mt-100 md:mb-100 h-4/5 md:h-4/5 lg:h-4/5">
                        ...
                        <input className="lg:pb-3 mb-2 mt-8 lg:w-2/4 md:w-3/4 w-5/6 rounded-xl bg-[#23354E] appearance-none border-2 border-[#20354E] text-gray-900 leading-tight focus:outline-none focus:bg-white focus:border-[#22C3FF]-500 " id="inline-name" type="text" placeholder="Username" name="email" value={credentials.email || ""} onChange={handleChange}></input>
                        <input className="lg:pb-3 mb-2 mt-2 lg:w-2/4 md:w-3/4 w-5/6 rounded-xl bg-[#23354E] appearance-none border-2 border-[#20354E] text-gray-900 leading-tight focus:outline-none focus:bg-white focus:border-[#22C3FF]-500" id="inline-name" type="text" placeholder="Password" name="password" value={credentials.password ||""} onChange={handleChange}></input>
