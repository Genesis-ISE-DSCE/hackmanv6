...
function Registeration({formData,setFormData}) {
        ...
        <div className="bg-[#24263B] pt-12">
            ...
            <form className="lg:w-full md:w-full w-full">
                ...
                <div className="lg:w-full lg:pt-12 md:w-full md:items-center md-center md:pt-8 items-center pt-10 place-content-center">
                    ...
                    <div className="">
                        <input className="w-full bg-[#23354E] appearance-none border-2 border-[#23354E] rounded focus:text-gray-900 text-[#D4DFC7] leading-tight focus:outline-none focus:bg-white focus:border-[#22C3FF]-500" id="inline-name" name="name" value={formData.name || ""} onChange={handleChange} type="text" placeholder="Enter your name"></input>
                    </div>
                </div>
                ...
                <div className="lg:w-full lg:pt-8 md:w-full md:items-center md-center md:pt-6 items-center pt-6 place-content-center">
                    ...
                    <div className="">
                        <input className="w-full bg-[#23354E] appearance-none border-2 border-[#23354E] rounded focus:text-gray-900 text-[#D4DFC7] leading-tight focus:outline-none focus:bg-white focus:border-[#22C3FF]-500 h-10 p-2" id="inline-email" name="email" value={formData.email || ""} onChange={handleChange} type="mail" placeholder="Enter your email"></input>
                    </div>
                </div>
                ...
                <div className="lg:w-full lg:pt-8 md:w-full md:items-center md-center md:pt-6 items-center pt-6 place-content-center">
                    ...
                    <div className="">
                        <input className="w-full bg-[#23354E] appearance-none border-2 border-[#23354E] rounded focus:text-gray-900 text-[#D4DFC7] leading-tight focus:outline-none focus:bg-white focus:border-[#22C3FF]-500" id="inline-full-name" name="phone" value={formData.phone || ""} onChange={handleChange} type="tel" placeholder="Enter your phone number"></input>
                    </div>
                </div>
