...
const Timeline = () => {
  ...
  return (
    <div className="mx-auto px-4 sm:px-6 lg:px-8 bg-[#24263B] pt-12 pb-16">
      <h1 className="lg:text-6xl lg:pb-4 md:text-4xl md:pb-4 text-[#22C3FF] pb-4 text-center font-poppins font-bold text-3xl">EVENT TIMELINE</h1>
        ...
        {events.map((event, index) => (
          <div
            ...
            className={`${index % 2 === 0 ? "lg:mr-auto" : "lg:ml-auto"
              } mb-8 rounded-lg shadow-lg bg-[#23354E] lg:w-2/5 ml-30 hidden lg:block`}
          >
            <div className="relative px-6 py-4">
