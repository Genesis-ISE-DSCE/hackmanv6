    ...
    return (
        <nav className="fixed top-0 left-0 right-0 bg-[#23354E] px-5 py-1 md:py-1 flex justify-between items-center z-10">
            ...
            <div className="hidden lg:block">
                ...
                <a href="#landing" className="text-[#22C3FF] text-base text-[22px] sm:mr-8 mr-3 hover:text-[26px]">Home</a>
                <a href="#themes" className="text-[#22C3FF] text-base text-[22px] sm:mr-8 mr-3 hover:text-[26px]">Themes</a>
                <a href="#schedule" className="text-[#22C3FF] text-base text-[22px] sm:mr-8 mr-3 hover:text-[26px]">Schedule</a>
                <a href="#sponsors" className="text-[#22C3FF] text-base text-[22px] sm:mr-8 mr-3 hover:text-[26px]">Sponsors</a>
                <a href="#faq" className="text-[#22C3FF] text-base text-[22px] sm:mr-8 mr-3 hover:text-[26px]">Faqs</a>
            ...
            <div className={`${isOpen ? "block" : "hidden"} lg:hidden absolute top-10 left-0 right-0 bg-[#23354E] text-center rounded-lg pb-4`}>
                ...
                <a href="#" className="block text-[#E5F2FF] font-bold text-sm mb-1" onClick={() => { setIsOpen(!isOpen); }} >Home</a>
