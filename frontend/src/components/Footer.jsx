            ...
            <div class="container px-3 pt-5 sm:pt-8 mx-auto">
                <div class="flex flex-wrap md:text-center text-center order-first">
                    <div class="lg:w-1/3 md:w-1/2 w-full px-4 py-0">
                        <h2 class="font-poppins text-white text-base sm:text-xl font-bold tracking-widest mb-1 sm:mb-2">Reach Out To Us</h2>
                        <div class="list-none mb-4 sm:mb-10">
                            ...
                            <li>
                                <p class="text-white text-xs sm:text-xl hover:text-[#22C3FF]">Ananya M: <a href="tel:">+911234567890</a></p>
                            </li>
                            <li>
                    ...
                    <div class="lg:w-1/3 md:w-1/2 w-full px-4 py-0">
                        <h2 class="font-poppins text-white text-base sm:text-xl font-bold tracking-widest mb-1 sm:mb-2">Connect with Us On</h2>
                        <div className="flex justify-center text-white text-xs sm:text-xl ">
                            <div className="">
                                <a href="https://instagram.com/genesis.ise?igshid=NTc4MTIwNjQ2YQ==" rel='noreferrer noopener' target="_blank"><Instagram size= {30} className='hover:text-[#22C3FF] lg:hover:scale-125 md:text-5xl md:hover:scale-125 text-3xl' /></a>
                            </div>
                            <div className="ml-8 insta">
                                <a href="https://www.linkedin.com/company/gensis-ise-dsce/" rel='noreferrer noopener' target="_blank"><Linkedin size= {30} className='hover:text-[#22C3FF] lg:text-5xl lg:hover:scale-125 md:text-5xl md:hover:scale-125 text-3xl'/></a>
                            </div>
                            <div className="ml-8 mb-4 sm:mb-10">
                                <a href="https://instagram.com/wearehackman?igshid=NTc4MTIwNjQ2YQ==" rel='noreferrer noopener' target="_blank"><Instagram size= {30} className='hover:text-[#22C3FF] lg:text-5xl lg:hover:scale-125 md:text-5xl md:hover:scale-125 text-3xl'/></a>
                            </div>
                        </div>
                    </div>
